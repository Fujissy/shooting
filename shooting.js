...
function keyPressed() {
    switch (keyCode) {
        case UP_ARROW:    keys[0] = true; break;
        case DOWN_ARROW:  keys[1] = true; break;
        case LEFT_ARROW:  keys[2] = true; break;
        case RIGHT_ARROW: keys[3] = true; break;
        case SHIFT:       keys[4] = true; break;
...
function keyReleased() {
    switch (keyCode) {
        case UP_ARROW:    keys[0] = false; break;
        case DOWN_ARROW:  keys[1] = false; break;
        case LEFT_ARROW:  keys[2] = false; break;
        case RIGHT_ARROW: keys[3] = false; break;
        case SHIFT:       keys[4] = false; break;
